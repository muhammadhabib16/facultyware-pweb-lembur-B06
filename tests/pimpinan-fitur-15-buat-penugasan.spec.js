...
test('Pimpinan Fitur 15: Membuat Penugasan Lembur Pegawai', async ({ page }) => {
  ...
  const uniqueTitle = `Assign - ${Date.now()}`;
  await page.fill('input[name="title"]', uniqueTitle);
  await page.fill('textarea[name="description"]', 'Deskripsi penugasan.');
